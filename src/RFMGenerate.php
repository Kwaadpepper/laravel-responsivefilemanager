...
class RFMGenerate extends Command
{
    ...
    {
        $currentKey = isset($this->laravel['config']['rfm.access_keys'][0]) ? $this->laravel['config']['rfm.access_keys'][0] : '';
    ...
    protected function writeNewEnvironmentFileWith($key)
    {
        ...
        switch ($o) {
            case 1:
                ...
                return file_put_contents($this->laravel->environmentFilePath(), preg_replace(
    ...
    {
        $k = isset($this->laravel['config']['rfm.access_keys'][0]) ? $this->laravel['config']['rfm.access_keys'][0] : '';
